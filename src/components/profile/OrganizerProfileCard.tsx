...
export default function OrganizerProfileCard({
  ...
  return (
    <section className="overflow-hidden rounded-[32px] border border-black/5 bg-white shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
      <div
        className="h-44 bg-[radial-gradient(circle_at_top,rgba(34,211,238,0.22),transparent_45%),linear-gradient(135deg,#e8f7fb_0%,#f5f8ff_55%,#f6fbff_100%)]"
        style={
          profile.banner_url
            ? {
      ...
      <div className="px-6 pb-6">
        <div className="-mt-12 rounded-[28px] border border-black/5 bg-white/95 p-5 shadow-[0_10px_30px_rgba(15,23,42,0.06)] backdrop-blur-sm">
