export default function TournamentBracket({
  ...
  const getMatchY = (round, matchIndex) => {
    const totalHeight =
      Math.pow(2, totalRounds - 1) * (MATCH_HEIGHT + ROW_GAP) - ROW_GAP
  ...
  const totalHeight =
    Math.pow(2, totalRounds - 1) * (MATCH_HEIGHT + ROW_GAP) + 40
  ...
  return (
    <div className="overflow-x-auto pb-4">
      <div
        ...
        className={locked ? 'grayscale opacity-50 pointer-events-none' : ''}
      >
        {/* SVG Lines */}
        <svg
          style={{
                    ...
                    style={{
                      ...
                      fontWeight:
                        ...
                        match.participant_a
                          ...
                          : '400',
                      color:
                        isSkeleton || !match.participant_a
                          ? '#d1d5db'
                          : match.winner === match.participant_a
                          ? '#111827'
                          : '#6b7280',
                    ...
                    style={{
                      ...
                      fontWeight:
                        ...
                        match.participant_b
                          ...
                          : '400',
                      color:
                        isSkeleton || !match.participant_b
                          ? '#d1d5db'
                          : match.winner === match.participant_b
                          ? '#111827'
                          : '#6b7280',
